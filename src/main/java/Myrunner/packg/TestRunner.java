...
@CucumberOptions(
		features = "src\\main\\java\\features\\taggedhooks.feature" //path of the feature file
		...
		,strict = true //It'll check if any of the step is not defined, then ik'll fail the execution

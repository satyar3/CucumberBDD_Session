...
@CucumberOptions(
		...
		//,plugin = {"pretty","html:test-output","json:test-output","junit:junit_xml/cucumber.xml"} //------> for reporting 
		...
		//,tags = {"@SmokeTest" , "@RegressionTest"} //"," stands for And where both are separately defined, here  SmokeTest and Regression will be executed
